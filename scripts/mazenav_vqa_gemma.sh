...
export OUTPUT_DIR="./outputs/mazenav_vqa"

python3 -m accelerate.commands.launch \
    --num_processes=1 \
    -m lmms_eval \
    --model vllm \
    --model_args model_version="google/gemma-3-4b-it",gpu_memory_utilization=0.95,max_videos=0,max_audios=0,max_images=1,max_model_len=4096 \
    --tasks mazenav_vqa \
    --batch_size 1 \
    --log_samples \
